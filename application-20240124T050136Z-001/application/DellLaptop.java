...
public class DellLaptop extends DellStore implements Initializable,Runnable
{
	@FXML
	Text info;
	@FXML
	...
	public void initialize(URL arg0, ResourceBundle arg1)
	{
		...
		mrp.setText(mrpOfDell[index]);
		brand.setText(brand.getText()+"Dell");
		model.setText(model.getText()+modelOfDell[index]);
		gpu.setText(gpu.getText()+gpuOfDell[index]);
		resolution.setText(resolution.getText()+refreshOfDell[index]);
		os.setText(os.getText()+osOfDell[index]);
		dimension.setText(dimension.getText()+dimensionOfDell[index]);
		weight.setText(weight.getText()+weightOfDell[index]);
		refresh.setText(refresh.getText()+refreshOfDell[index]);
		ratio.setText(ratio.getText()+ratioOfDell[index]);
		size.setText(size.getText()+sizeOfDell[index]);
		processor.setText(processor.getText()+processorOfDell[index]);
		memory.setText(memory.getText()+memoryOfDell[index]);
		storage.setText(storage.getText()+storageOfDell[index]);
