...
public class AsusStore extends DisplayPage implements Initializable,Runnable,AsusProducts
{
	@FXML
	VBox mainVBox;
	...
	public void initialize(URL arg0, ResourceBundle arg1)
	{
	    for (int i = 0; i < 25; i++) 
	    {
	        ...
	        currentMRP.setText(mrpOfAsus[i]);
	        ...
	        if (currentHBox != null)
	        {
	            ...
	            {   	
	                ...
	                {
	                    displayAsusLaptop(currentIndex,tempBox);
	                }
	            });
	        }
	    }
	...
	protected void displayAsusLaptop(int indexOfHBox,HBox tempBox) 
	{
		index = indexOfHBox;
		mrpOfLaptop = mrpOfAsus[index];
	    try
	    {
	    	tempForCart = tempBox;
	        Stage asusStage = new Stage(); 
	        Parent asusRoot = FXMLLoader.load(getClass().getResource("AsusLaptop.fxml"));
