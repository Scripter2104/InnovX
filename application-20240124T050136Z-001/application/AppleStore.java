...
public class AppleStore extends DisplayPage implements Initializable,Runnable,AppleProducts
{
	@FXML
	VBox mainVBox;
	...
	public void initialize(URL arg0, ResourceBundle arg1)
	{
	    for (int i = 0; i < 25; i++) 
	    {
	        ...
	        currentMRP.setText(mrpOfApple[i]);
	        ...
	        if (currentHBox != null)
	        {
	            ...
	            {   	
	                ...
	                {
	                    displayAppleLaptop(currentIndex,tempBox);
	                }
	            });
	        }
	    }
	...
	protected void displayAppleLaptop(int indexOfHBox,HBox tempBox) 
	{
		index = indexOfHBox;
		mrpOfLaptop = mrpOfApple[index];
	    try
	    {
	    	tempForCart = tempBox;
	        Stage appleStage = new Stage(); 
	        Parent appleRoot = FXMLLoader.load(getClass().getResource("AppleLaptop.fxml"));
