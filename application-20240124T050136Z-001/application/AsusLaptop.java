...
public class AsusLaptop extends AsusStore implements Initializable,Runnable
{
	@FXML
	Text info;
	@FXML
	...
	public void initialize(URL arg0, ResourceBundle arg1)
	{
		...
		mrp.setText(mrpOfAsus[index]);
		brand.setText(brand.getText()+"Asus");
		model.setText(model.getText()+modelOfAsus[index]);
		gpu.setText(gpu.getText()+gpuOfAsus[index]);
		resolution.setText(resolution.getText()+refreshOfAsus[index]);
		os.setText(os.getText()+osOfAsus[index]);
		dimension.setText(dimension.getText()+dimensionOfAsus[index]);
		weight.setText(weight.getText()+weightOfAsus[index]);
		refresh.setText(refresh.getText()+refreshOfAsus[index]);
		ratio.setText(ratio.getText()+ratioOfAsus[index]);
		size.setText(size.getText()+sizeOfAsus[index]);
		processor.setText(processor.getText()+processorOfAsus[index]);
		memory.setText(memory.getText()+memoryOfAsus[index]);
		storage.setText(storage.getText()+storageOfAsus[index]);
